...
const PAGES = [
  ...
  ['cause.html', '?id=atmosphere', ['#ct-rail .ct-node', '#ct-sec-1', '#ct-sec-2', '#ct-sec-3', '#ct-sec-4',
                                    '.ct-sec--open', '.ct-sec--now', '#ct-startline',
                                    '#ct-rail .ct-node__date', '#leading-initiatives-panel',
                                    '#ct-sec-1-name', '#ct-sec-4-name']],
  ['main.html', '', ['#main-toggle-btn',
                     '#hero-topgrid', '#ebx-top-card-mount .tc-half', '#ebx-top-card-mount-b .tc-half--tall',
                     '.tc-half__head--sentence', '#hero-controlblock .nextvotes__row',
  ...
  ['main.html', '?state=oe', ['#main-toggle-btn', '#hero-topgrid.hero__topgrid--oe',
